...
import { artifactRevisions, artifacts } from "@bob/db/schema/artifacts"
import { agentRuns, messages } from "@bob/db/schema/conversations"
...
export interface ArtifactRunRevisionPlan {
  ...
  readonly statements: readonly [CoreBatchQuery, ...CoreBatchQuery[]]
}
...
export function makeArtifactPersistence(
  ...
  ownerDataKeys: OwnerDataKeyStore,
