...
const fixtureConfig = {
  ...
  CONNECTIONS_GATEWAY_URL: "https://connections.offline.invalid",
  CONNECTIONS_GATEWAY_ACCESS_CLIENT_ID: "offline-connections-client-id",
  CONNECTIONS_GATEWAY_ACCESS_CLIENT_SECRET: "offline-connections-client-secret",
  SENDBLUE_ENABLED: true,
  SENDBLUE_ACCOUNT_ID: "offline-sendblue-account-fixture",
  SENDBLUE_LINE_ID: "offline-sendblue-line-fixture",
  SENDBLUE_API_KEY_ID: "offline-sendblue-key-fixture",
  SENDBLUE_API_SECRET_KEY: "offline-sendblue-secret-fixture",
  SENDBLUE_WEBHOOK_SIGNING_SECRET: "offline-sendblue-webhook-fixture",
