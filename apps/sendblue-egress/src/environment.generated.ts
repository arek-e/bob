...
type _CoercedEnvSchema_fc8110ce = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_fc8110ce = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'SENDBLUE_STATUS_CALLBACK_URL' | 'BAO_ADDR' | 'BAO_JWT_ROLE'>>;
