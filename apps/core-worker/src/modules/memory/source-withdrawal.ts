...
import { factEvidence, factRevisions, facts, memoryCandidates } from "./schema.ts"
 ...
 *
 * The caller must include every returned statement in the same D1 batch as the source mutation.
 */
