...
type _CoercedEnvSchema_d647154b = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_d647154b = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'BAO_ADDR' | 'BAO_JWT_ROLE'>>;
