...
export type CoercedEnvSchema = {
  ...
  /**
   * **BOB_UI_HOST**  
   * Local host for the static production-build preview server.  
  ...
  /**
   * **BOB_UI_PORT**  
   * Local port for the static production-build preview server.  
...
type _CoercedEnvSchema_50fdf5d6 = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_50fdf5d6 = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'PUBLIC_API_BASE_URL' | 'BOB_UI_HOST' | 'BOB_UI_PORT'>>;
