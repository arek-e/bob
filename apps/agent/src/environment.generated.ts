...
type _CoercedEnvSchema_933a7e79 = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_933a7e79 = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'PORT' | 'BAO_KUBERNETES_ROLE' | 'BAO_KUBERNETES_JWT_PATH' | 'BOB_PROVIDER' | 'BOB_MODEL' | 'BOB_ALLOWED_MODELS' | 'BAO_ADDR'>>;
