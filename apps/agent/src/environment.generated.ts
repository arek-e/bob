...
export type CoercedEnvSchema = {
   ...
   * In-cluster OTLP/HTTP collector base URL.  
...
type _CoercedEnvSchema_22a02cdc = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_22a02cdc = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'PORT' | 'BAO_KUBERNETES_ROLE' | 'BAO_KUBERNETES_JWT_PATH' | 'BOB_PROVIDER' | 'BOB_MODEL' | 'BOB_ALLOWED_MODELS' | 'BOB_RELEASE_SHA' | 'OTEL_EXPORTER_OTLP_ENDPOINT' | 'BAO_ADDR'>>;
