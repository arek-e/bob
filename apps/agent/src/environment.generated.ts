...
type _CoercedEnvSchema_d9f35296 = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_d9f35296 = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'PORT' | 'BAO_APPROLE_ROLE_ID' | 'BAO_APPROLE_SECRET_ID' | 'BOB_PROVIDER' | 'BOB_MODEL' | 'BOB_ALLOWED_MODELS' | 'BOB_RELEASE_SHA' | 'OTEL_EXPORTER_OTLP_ENDPOINT' | 'BAO_ADDR'>>;
