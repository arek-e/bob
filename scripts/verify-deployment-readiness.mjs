...
const [
  ...
  readFile("infra/kubernetes/base/backup-job.yaml", "utf8"),
  readFile("infra/kubernetes/base/backup-secret-delivery.yaml", "utf8"),
  readFile("infra/kubernetes/base/backup-network-policy.yaml", "utf8"),
  ...
  readFile("infra/openbao/backup-secret-delivery-production-policy.hcl", "utf8"),
