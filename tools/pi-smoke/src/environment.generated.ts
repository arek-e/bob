...
type _CoercedEnvSchema_3e72f89d = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_3e72f89d = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'AGENT_ADMIN_URL' | 'BAO_ADDR' | 'BAO_JWT_ROLE'>>;
